...
public class CopperLongtails extends Script{
    ...
    final static int birdSnareSuccessID = 9379;
...
//    final int boxTrapSuccessID = 9382;    // On ground success (green)
    ...
    static int xCoord = General.random(xMinCoordinate, xMaxCoordinate);
    static int yCoord = General.random(yMinCoordinate, yMaxCoordinate);

    //initial = 2342, 3590, 0
    static ArrayList<Location> locations = new ArrayList<Location>() {
        {
            add(new Location(xCoord, yCoord , zCoordinate));
...
//                    System.out.println("TRAPS YCOORD IS: " + taskToHandle.trapToHandle.locationOnGround.getY());
                    ...
                    General.sleep(General.randomSD(1200,1400,1300,1300));
...
//                    }
            ...
            General.sleep(General.randomSD(1000,2000, 1300, 1300));
...
//            }
    ...
    public void placeDownTrap(Location location) {
        ...
        if (Player.getPosition() != location.tile.getPosition()) {
